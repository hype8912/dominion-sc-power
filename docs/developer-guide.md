...
**Superseded periods:** `RATE_1_2025`, `RATE_2_2025`, `RATE_6_2025`, `RATE_7_2025`, and `RATE_8_2025` (effective 2025-07-23 to 2026-06-30, `effective_to` set) archive the prior tariffs, `RATE_32V_2025` does the same for gas (2025-09-01 to 2026-06-30), as does `RATE_32S_2025` for Rate 32S (2025-09-01 to 2026-06-30), and Rate 5 has `RATE_5_2024` (2024-09-01 to 2025-04-30) and `RATE_5_2025` (2025-05-01 to 2026-06-30). Each is a complete plan with its `source_url`, so historical usage can be priced with the same billing code. Rate 5's May 2025 tariff and July 23, 2025 revision publish the same prices, so they are one period; the May tariff only says "first billing cycle of May 2025", so its start is approximated as the first of the month. None of these are in the three `RESIDENTIAL_*` mappings.
