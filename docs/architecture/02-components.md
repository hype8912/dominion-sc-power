...
| `rates.py` | `RATE_1`...`RATE_8`, `RATE_32S`, `RATE_32V`, `RATE_1_2025`, `RATE_2_2025`, `RATE_5_2024`, `RATE_5_2025`, `RATE_6_2025`, `RATE_7_2025`, `RATE_8_2025`, `RATE_32V_2025`, `RATE_PLAN_HISTORY`, `get_rate_plan()`, `get_rate_plan_history()`, `get_rate_plan_for_date()` | Public entry point: assembles the per-plan modules into the catalog mappings, `RATE_PLAN_HISTORY`, and lookup functions; no network calls |
